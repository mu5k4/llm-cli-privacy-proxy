...
assert "ghp_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" in text
assert '"type":"response.output_text.delta","delta":"ghp_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"' in text
...
async def main():
    ...
    try:
        ...
        try:
            app.nosey_parker_spans("ghp_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
